...
public class Packet {
    ...
    static {
      ...
      clientBoundPackets.put(0x2D, Packet2DCombatEvent.class);
      clientBoundPackets.put(0x2E, Packet2EPlayerListItem.class);
      clientBoundPackets.put(0x2F, Packet2FPlayerPositionAndLook.class);
      clientBoundPackets.put(0x30, Packet30UseBed.class);
      clientBoundPackets.put(0x31, Packet31UnlockRecipes.class);
      clientBoundPackets.put(0x32, Packet32DestroyEntities.class);
      ...
      clientBoundPackets.put(0x38, Packet38WorldBorder.class);
      ...
      clientBoundPackets.put(0x43, Packet43SetPassengers.class);
      clientBoundPackets.put(0x44, Packet44Teams.class);
      clientBoundPackets.put(0x45, Packet45UpdateScore.class);
      clientBoundPackets.put(0x46, Packet46SpawnPosition.class);
      clientBoundPackets.put(0x47, Packet47TimeUpdate.class);
      clientBoundPackets.put(0x48, Packet48Title.class);
      ...
      clientBoundPackets.put(0x4D, Packet4DAdvancements.class);
      clientBoundPackets.put(0x4E, Packet4EEntityProperties.class);
