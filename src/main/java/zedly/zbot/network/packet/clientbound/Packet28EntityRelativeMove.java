...
/**
* This packet is sent by the server when an entity moves less then 8 blocks; if an entity moves more than 8 blocks <a href="#Entity_Teleport">Entity Teleport</a> should be sent instead.
*/
...
public class Packet28EntityRelativeMove implements ClientBoundPacket {
