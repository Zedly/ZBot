...
/**
* This packet is sent by the server when an entity moves less then 8 blocks; if an entity moves more than 8 blocks <a href="#Teleport_Entity">Teleport Entity</a> should be sent instead.
*/

public class Packet2BUpdateEntityPosition implements ClientBoundPacket {
