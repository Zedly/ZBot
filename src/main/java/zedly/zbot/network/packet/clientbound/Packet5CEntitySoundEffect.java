...
public class Packet5CEntitySoundEffect implements ClientBoundPacket {
    private int soundID;  // ID of hardcoded sound event (<a rel="nofollow" class="external text" href="https://pokechu22.github.io/Burger/1.16.5.html#sounds">events</a> as of 1.16.5).
