...
For horses, use <a href="#Open_Horse_Screen">Open Horse Screen</a>.
*/

public class Packet30OpenScreen implements ClientBoundPacket {
    ...
    private int windowType;  // The window type to use for display. Contained in the <code>minecraft:menu</code> registry; see <a href="/Inventory" title="Inventory">Inventory</a> for the different values.
