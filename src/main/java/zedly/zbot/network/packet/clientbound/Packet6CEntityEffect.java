...
public class Packet6CEntityEffect implements ClientBoundPacket {
    ...
    private boolean hasFactorData;  // Used in DARKNESS effect
    private NBTBase factorCodec;  // See below
    ...
    public void readPacket(ExtendedDataInputStream dis, int packetLen) throws IOException {
        ...
        flags = dis.readByte();
        hasFactorData = dis.readBoolean();
        factorCodec = dis.readNBT();
    }
