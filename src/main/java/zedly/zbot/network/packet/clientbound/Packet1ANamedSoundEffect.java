 ...
 * resource packs.
 */
public class Packet1ANamedSoundEffect implements ClientBoundPacket {

    private String soundName;  // All sound effect names as of 1.15.2 can be seen <a rel="nofollow" class="external text" href="https://pokechu22.github.io/Burger/1.15.2.html#sounds">here</a>.
