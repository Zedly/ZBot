...
public class Packet38PlayerPositionAndLook implements ClientBoundPacket {
    ...
    private int teleportID;  // Client should confirm this packet with <a href="#Teleport_Confirm">Teleport Confirm</a> containing the same Teleport ID.
    private boolean dismountVehicle;  // True if the player should dismount their vehicle.
    ...
    public void readPacket(ExtendedDataInputStream dis, int packetLen) throws IOException {
        ...
        dismountVehicle = dis.readBoolean();
    }
