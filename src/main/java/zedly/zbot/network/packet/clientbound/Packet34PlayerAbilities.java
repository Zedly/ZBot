...
public class Packet34PlayerAbilities implements ClientBoundPacket {
    private int flags;  // Bit field, see below.
    private double flyingSpeed;  // 0.05 by default.
    private double fieldofViewModifier;  // Modifies the field of view, like a speed potion. A Notchian server will use the same value as the movement speed sent in the <a href="#Update_Attributes">Update Attributes</a> packet, which defaults to 0.1 for players.
