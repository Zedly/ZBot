...
public class Packet08AcknowledgePlayerDigging implements ClientBoundPacket {
    ...
    private boolean successful;  // True if the digging succeeded; false if the client should undo any changes it made locally.
