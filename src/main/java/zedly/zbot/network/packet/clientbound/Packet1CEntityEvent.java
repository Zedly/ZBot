...
public class Packet1CEntityEvent implements ClientBoundPacket {
    private int entityID;
    private int entityStatus;  // See <a href="/Entity_statuses" title="Entity statuses">Entity statuses</a> for a list of which statuses are valid for each type of entity.
