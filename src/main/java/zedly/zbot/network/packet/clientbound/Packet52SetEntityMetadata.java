...
/**
* Updates one or more <a href="/Entity_metadata#Entity_Metadata_Format" title="Entity metadata">metadata</a> properties for an existing entity. Any properties not included in the Metadata field are left unchanged.
*/

public class Packet52SetEntityMetadata implements ClientBoundPacket {
