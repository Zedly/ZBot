...
/**
* This packet is sent when an entity has been <span class="plainlinks"><a rel="nofollow" class="external text" href="https://minecraft.fandom.com/wiki/Lead">leashed</a></span> to another entity.
*/

public class Packet53LinkEntities implements ClientBoundPacket {
