...
public class Packet08ClickWindow implements ServerBoundPacket {
    ...
    public Packet08ClickWindow(int windowID, int lastStateId, int slot, int button, int actionNumber, int mode, List<Pair<Integer, ItemStack>> expectedNewStates, ItemStack clickeditem) {
