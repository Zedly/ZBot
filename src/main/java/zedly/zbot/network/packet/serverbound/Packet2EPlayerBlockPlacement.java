...
public class Packet2EPlayerBlockPlacement implements ServerBoundPacket {
    ...
    public Packet2EPlayerBlockPlacement(int hand, Location location, int face, double cursorPositionX, double cursorPositionY, double cursorPositionZ, boolean insideblock) {
        this.hand = hand;
