...
/**
* A combination of <a href="#Player_Rotation">Player Rotation</a> and <a href="#Player_Position">Player Position</a>.
*/

public class Packet12PlayerPositionAndRotation implements ServerBoundPacket {
    ...
    public Packet12PlayerPositionAndRotation(Location loc, boolean onGround) {
        this(loc.getX(), loc.getY(), loc.getZ(), loc.getYaw(), loc.getPitch(), onGround);
    }

    public Packet12PlayerPositionAndRotation(double x, double feetY, double z, double yaw, double pitch, boolean onGround) {
        this.x = x;
        this.feetY = feetY;
        this.z = z;
        this.yaw = yaw;
