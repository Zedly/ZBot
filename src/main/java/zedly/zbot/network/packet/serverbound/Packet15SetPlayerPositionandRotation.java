 ...
 */
/**
 * A combination of <a href="#Set_Player_Rotation">Move Player Rotation</a> and
 * <a href="#Set_Player_Position">Move Player Position</a>.
 */
public class Packet15SetPlayerPositionandRotation implements ServerBoundPacket {
    ...
    public Packet15SetPlayerPositionandRotation(Location loc, boolean onGround) {
        this(loc.getX(), loc.getY(), loc.getZ(), loc.getYaw(), loc.getPitch(), onGround);
    }

    public Packet15SetPlayerPositionandRotation(double x, double feetY, double z, double yaw, double pitch, boolean onGround) {
        this.x = x;
        this.feetY = feetY;
        this.z = z;
        this.yaw = yaw;
