...
public class Packet2CProgramJigsawBlock implements ServerBoundPacket {
    ...
    public Packet2CProgramJigsawBlock(Location location, String name, String target, String pool, String finalstate, String jointtype) {
