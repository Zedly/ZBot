...
/**
* If a confirmation sent by the client was not accepted, the server will reply with a <a href="#Window_Confirmation_.28clientbound.29">Window Confirmation (clientbound)</a> packet with the Accepted field set to false. When this happens, the client must send this packet to apologize (as with movement), otherwise the server ignores any successive confirmations.
*/

public class Packet07WindowConfirmation implements ServerBoundPacket {
    ...
    public Packet07WindowConfirmation(int windowID, int actionNumber, boolean accepted) {
