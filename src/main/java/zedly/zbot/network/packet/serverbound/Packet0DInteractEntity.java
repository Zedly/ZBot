 ...
 * @author Dennis
 */
public class Packet0DInteractEntity implements ServerBoundPacket {
    int targetId;
    int clickType;
    int hand;
    Location loc;

    public Packet0DInteractEntity(int targetId, int hand) {
        this.targetId = targetId;
        this.hand = hand;
        this.clickType = 0;
    }

    public Packet0DInteractEntity(int targetId) {
        this.targetId = targetId;
        this.clickType = 1;
    }

    public Packet0DInteractEntity(int targetId, Location loc, int hand) {
        this.targetId = targetId;
        this.clickType = 2;
        this.loc = loc;
        this.hand = hand;
