...
public class Packet27UpdateCommandBlockMinecart implements ServerBoundPacket {
    ...
    public Packet27UpdateCommandBlockMinecart(int entityID, String command, boolean trackOutput) {
