 ...
 * Sent when the player connects, or when settings are changed.
 */
public class Packet05ClientSettings implements ServerBoundPacket {
    ...
    public Packet05ClientSettings(String locale, int viewDistance, int chatMode, boolean chatColors, int displayedSkinParts, int mainHand, boolean enabletextfiltering, boolean allowserverlistings) {
        this.locale = locale;
