 ...
 * @author Dennis
 */
public class Packet0EInteractEntity implements ServerBoundPacket {
    int targetId;
    int clickType;
    int hand;
    Location loc;

    public Packet0EInteractEntity(int targetId, int hand) {
        this.targetId = targetId;
        this.hand = hand;
        this.clickType = 0;
    }

    public Packet0EInteractEntity(int targetId) {
        this.targetId = targetId;
        this.clickType = 1;
    }

    public Packet0EInteractEntity(int targetId, Location loc, int hand) {
        this.targetId = targetId;
        this.clickType = 2;
        this.loc = loc;
        this.hand = hand;
