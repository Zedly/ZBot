...
public class Packet09ClickWindow implements ServerBoundPacket {
    ...
    public Packet09ClickWindow(int windowID, int slot, int button, int actionNumber, int mode, ItemStack clickeditem) {
